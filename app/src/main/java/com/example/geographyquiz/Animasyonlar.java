...
public class Animasyonlar {
    ...
    public static void yaziAnimasyonu(TextView soru_tv, int nextInt) {
        switch (nextInt){
            case 0:
    ...
    public static void butonlarAnimasyonu(List<View> butonlar) {
        ...
        ObjectAnimator objectAnimator1 = ObjectAnimator.ofInt(butonlar.get(0),"translationY",500,0);
        ...
        objectAnimator1.setDuration(1250);
    ...
    public static void TitresimAnimasyonu(RelativeLayout soruContainer) {
        AnimatorSet animatorSet = new AnimatorSet();
